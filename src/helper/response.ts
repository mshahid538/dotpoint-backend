export const responseMessage = {
    ...
    emailVerificationLinkExpired: "Email verification link was expired!",
    emailVerified: "Email verification has been completed!",
    emailResentSuccess: "Verification email has been sent successfully!",
    ...
    dataAlreadyExist: (message: any): any => { return `Since the ${message} is already in use, kindly modify it!` },
    ...
    tenantRequestSuccess: (message: string): any => { return `Your ${message[0].toUpperCase() + message.slice(1).toLowerCase()} request has been successfully sent!` },
