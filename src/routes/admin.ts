...
//          Coupon
router.get("/coupon", adminController.all_coupons);
router.post("/coupon", adminController.add_coupon);
router.patch("/coupon", adminController.update_coupon);
router.delete("/coupon/:id", adminController.delete_coupon);
...
router.post(
    ...
    adminController.get_challenge_list_pagination
);
...
router.post(
    "/challenge_users/get",
    validation.get_challenge_list_pagination,
    adminController.get_challenge_users_pagination
);
...
router.post(
    "/currency_list/get",
    validation.get_currency_list_pagination,
    adminController.get_currency_list_pagination
);
...
//          payment withdrawal
router.post(
    "/payment_withdrawal/status_update",
    validation.payment_withdrawal_status_update,
    adminController.payment_withdrawal_status_update
);
router.post(
    "/payment_withdrawal/get_list",
    validation.get_challenge_list_pagination,
    adminController.payment_withdrawal_get_list
    );
    
router.post(
    "/profit_withdrawal/get",
    validation.get_buy_challenge_list_pagination,
    adminController.get_list_profit_withdrawal
);
router.post("/profit_withdrawal/approval", validation.payout_request, adminController.payout_request);

//          customer support
router.post(
    "/customer_support/get",
    validation.get_buy_challenge_list_pagination,
    adminController.get_list_customer_support
);
